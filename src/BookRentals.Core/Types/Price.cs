...
namespace BookRentals.Core.Types
{
    public readonly struct Price : IEquatable<Price>
    {
        ...
        {
            if (IsNegative())
                throw new InvalidOperationException("Cena nemůže být záporná.");
        }
        ...
        public static Price operator -(Price x, Money y)
        {
            if (!x.Currency.Equals(y.Currency))
                throw new ArgumentException("Měna odečítaných cen musí být stejná.");
        ...
        {
            if (!x.Currency.Equals(y.Currency))
                throw new ArgumentException("Měna sčítaných cen musí být stejná.");
        ...
        {
            if (!x.Currency.Equals(y.Currency))
                throw new ArgumentException("Měna porovnávaných cen musí být stejná.");
        ...
        {
            if (!x.Currency.Equals(y.Currency))
                throw new ArgumentException("Měna porovnávaných množství musí být stejná.");
